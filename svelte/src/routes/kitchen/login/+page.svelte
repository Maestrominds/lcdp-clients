<script>
    ...
    async function requestOTP() {
        ...
        try {
            ...
            error =
                "Kitchen access denied. Please ensure your number is registered as Kitchen Staff.";
        } finally {
            loading = false;
        }
    }
...
<div class="login-page">
    ...
    <div class="login-right">
        <div class="auth-card">
            ...
            {:else}
                <div class="auth-header">
                    <button class="mini-back" onclick={goBack}
                        >← Change Number</button
                    >
                    <h2>Verify Code</h2>
                    <p>
                        Enter the 6-digit OTP sent to <strong
                            >+91 {phone}</strong
                        >
                    </p>
                </div>
                ...
                <div class="field-group">
                    ...
                    {#if otpStatus === "otp_unavailable"}
                        <p class="otp-hint">
                            Debug Mode: Enter any code to continue
                        </p>
                    {/if}
                </div>
...
<style>
    ...
    .primary-btn:hover:not(:disabled) {
        ...
        box-shadow: 0 8px 20px rgba(30, 95, 116, 0.3);
    }
